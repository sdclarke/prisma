...
class CategoryEditorDialog extends JDialog {
  ...
  public CategoryEditorDialog(
    ...
    this.comboBoxPuzzle.addActionListener(
        event -> {
          PuzzleInfo selectedPuzzle =
              (PuzzleInfo) CategoryEditorDialog.this.comboBoxPuzzle.getSelectedItem();
          ...
          DefaultListModel listModel =
              (DefaultListModel) CategoryEditorDialog.this.listTips.getModel();
    ...
    this.buttonTipAdd.addActionListener(
        event -> {
    ...
    this.buttonTipUp.addActionListener(
        event -> {
    ...
    this.buttonTipDown.addActionListener(
        event -> {
          JList listTips1 = CategoryEditorDialog.this.listTips;
    ...
    this.buttonTipRemove.addActionListener(
        event -> {
    ...
    this.buttonOk.addActionListener(
        event -> {
          // scrambler
          String scramblerId =
              ((ScramblerInfo) CategoryEditorDialog.this.comboBoxScrambler.getSelectedItem())
                  .getScramblerId();
          ...
          listener.categoryEdited(
              category.setScramblerId(scramblerId).setDescription(description).setTipIds(tipIds));
  ...
  private void createComponents() {
    setLayout(
        new MigLayout(
            "fill", "[pref!][fill][pref!]", "[pref!]8[pref!]8[pref!]8[pref!][grow]16[pref!]"));
    ...
    // buttonAdd
    this.buttonTipAdd = new JButton(i18n("category_editor.add"));
    ...
    // buttonTipUp
    this.buttonTipUp = new JButton(i18n("category_editor.up"));
    add(this.buttonTipUp, "sizegroup button, top, split 3, flowy");

    // buttonTipDown
    this.buttonTipDown = new JButton(i18n("category_editor.down"));
    add(this.buttonTipDown, "sizegroup button");

    // buttonTipRemove
    this.buttonTipRemove = new JButton(i18n("category_editor.remove"));
        ...
        event -> {
          Category category =
              new Category(
                  UUID.randomUUID(),
                  "RUBIKS-CUBE-RANDOM",
                  i18n("category_manager.new_category"),
                  true,
                  new String[0]);
