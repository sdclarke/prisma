...
public class AboutDialog extends JDialog {
  public AboutDialog(JFrame owner, boolean modal) {
    ...
    setTitle(i18n("about.prisma_puzzle_timer") + " " + i18n("about.version"));
    setResizable(false);
  ...
  private void createComponents() {
    ...
    JLabel labelPrismaPuzzleTimer =
        new JLabel(i18n("about.prisma_puzzle_timer") + " " + i18n("about.version"));
    labelPrismaPuzzleTimer.setFont(new Font("Arial", Font.BOLD, 16));
    add(labelPrismaPuzzleTimer, "split 3, gapbottom 10, flowy");

    // labelWalter
    JLabel labelContributors = new JLabel(i18n("about.contributors"));
