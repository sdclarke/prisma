...
public class ExportUtils {
  ...
  public static void ExportToFile(SolutionManager solutionManager) {
    ...
    String fileName = fileDate + " " + i18n("tools.export_filename");
    ...
    try {
      ...
      for (Solution solution : solutions) {
        ...
        String timeElapsed =
            SolutionUtils.formatSeconds(
                solution.getTiming().getElapsedTime(), "MILLISECONDS", false);
      ...
      JOptionPane.showMessageDialog(
          null,
          "Unable to export solutions: " + e.getMessage(),
          "Error",
