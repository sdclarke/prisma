...
public class TableSorter {
  ...
  public int compare(int column, int row1, int row2) {
    ...
    if (o1 == null && o2 == null) {
      ...
      if (model.getColumnName(column).equals(i18n("history.comment"))
          || model.getColumnName(column).equals(i18n("history.scramble"))) {
        return 0;
      ...
      } else if (model.getColumnName(column).equals(i18n("history.#"))) {
