...
public class Solution {
  ...
  public Solution setTiming(Timing timing) {
    return new Solution(
        this.solutionId, this.categoryId, this.scramble, timing, this.penalty, this.comment);
  }
  ...
  public Solution setPenalty(String penalty) {
    return new Solution(
        this.solutionId, this.categoryId, this.scramble, this.timing, penalty, this.comment);
  }
  ...
  public Solution setComment(String comment) {
    return new Solution(
        this.solutionId, this.categoryId, this.scramble, this.timing, this.penalty, comment);
  }
}
