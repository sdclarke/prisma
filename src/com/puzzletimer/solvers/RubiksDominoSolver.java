...
public class RubiksDominoSolver {
  ...
  static {
    State moveU =
        new State(new byte[] {3, 0, 1, 2, 4, 5, 6, 7}, new byte[] {3, 0, 1, 2, 4, 5, 6, 7});
    State moveD =
        new State(new byte[] {0, 1, 2, 3, 5, 6, 7, 4}, new byte[] {0, 1, 2, 3, 5, 6, 7, 4});
    State moveL =
        new State(new byte[] {7, 1, 2, 4, 3, 5, 6, 0}, new byte[] {0, 1, 2, 7, 4, 5, 6, 3});
    State moveR =
        new State(new byte[] {0, 6, 5, 3, 4, 2, 1, 7}, new byte[] {0, 5, 2, 3, 4, 1, 6, 7});
    State moveF =
        new State(new byte[] {0, 1, 7, 6, 4, 5, 3, 2}, new byte[] {0, 1, 6, 3, 4, 5, 2, 7});
    State moveB =
        new State(new byte[] {5, 4, 2, 3, 1, 0, 6, 7}, new byte[] {4, 1, 2, 3, 0, 5, 6, 7});
  ...
  public static State getRandomState(Random random) {
    return new State(
        IndexMapping.indexToPermutation(random.nextInt(N_CORNERS_PERMUTATIONS), 8),
        IndexMapping.indexToPermutation(random.nextInt(N_EDGES_PERMUTATIONS), 8));
  }
}
