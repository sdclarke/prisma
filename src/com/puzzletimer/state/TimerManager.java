...
public class TimerManager {
  public static class Listener {
    ...
    public void dataReceived(
        byte[] data, int offset, double period, byte[] decodedBits, byte[] decodedBytes) {}
  ...
  public boolean isAnyKeyEnabled() {
    return this.anyKeyEnabled;
  }
  ...
  public boolean isHideTimerEnabled() {
    return this.hideTimerEnabled;
  }
