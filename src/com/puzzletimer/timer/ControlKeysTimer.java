...
public class ControlKeysTimer implements Timer {
  ...
  public ControlKeysTimer(JFrame frame, TimerManager timerManager) {
    ...
    this.state =
        ControlKeysTimer.this.inspectionEnabled ? State.READY_FOR_INSPECTION : State.NOT_READY;
  }
            ...
            switch (ControlKeysTimer.this.state) {
              ...
              case RUNNING:
                if (ControlKeysTimer.this.leftPressed && ControlKeysTimer.this.rightPressed) {
                  ...
                  if (ControlKeysTimer.this.finish.getTime() - ControlKeysTimer.this.start.getTime()
                      < 250) {
                    break;
                  }
          ...
          public void keyReleased(KeyEvent keyEvent) {
            ...
            switch (ControlKeysTimer.this.state) {
              case READY:
                ...
                ControlKeysTimer.this.repeater.schedule(
                    new TimerTask() {
                      @Override
                      public void run() {
              ...
              case FINISHED:
                if (!ControlKeysTimer.this.leftPressed && !ControlKeysTimer.this.rightPressed) {
                  ControlKeysTimer.this.state =
                      ControlKeysTimer.this.inspectionEnabled
