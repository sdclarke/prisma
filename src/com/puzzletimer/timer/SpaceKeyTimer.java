        ...
        new KeyAdapter() {
          ...
          public void keyPressed(KeyEvent keyEvent) {
            ...
            if (keyEvent.getKeyCode() != KeyEvent.VK_SPACE
                && timerManager.isAnyKeyEnabled()
                && SpaceKeyTimer.this.state != State.RUNNING) return;

            switch (SpaceKeyTimer.this.state) {
              case RUNNING:
                SpaceKeyTimer.this.finish = new Date();
                if (SpaceKeyTimer.this.finish.getTime() - SpaceKeyTimer.this.start.getTime()
                    < 250) {
                  break;
                }
          ...
          public void keyReleased(KeyEvent keyEvent) {
            ...
            switch (SpaceKeyTimer.this.state) {
              ...
              case READY:
                ...
                SpaceKeyTimer.this.repeater.schedule(
                    new TimerTask() {
                      @Override
                      public void run() {
              ...
              case FINISHED:
                SpaceKeyTimer.this.state =
                    SpaceKeyTimer.this.inspectionEnabled ? State.READY_FOR_INSPECTION : State.READY;
                break;
            }
