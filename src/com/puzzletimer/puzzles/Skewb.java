...
public class Skewb implements Puzzle {
  ...
  public Mesh getScrambledPuzzleMesh(ColorScheme colorScheme, String[] sequence) {
    ...
    Plane planeL =
        new Plane(new Vector3(0.5, 0.5, 0), new Vector3(0.5, 0, -0.5), new Vector3(0, -0.5, -0.5));
    Plane planeR =
        new Plane(new Vector3(0.5, 0, -0.5), new Vector3(0, 0.5, -0.5), new Vector3(-0.5, 0.5, 0));
    Plane planeD =
        new Plane(new Vector3(0, 0.5, -0.5), new Vector3(0.5, 0.5, 0), new Vector3(0.5, 0, 0.5));
    Plane planeB =
        new Plane(new Vector3(0.5, 0, 0.5), new Vector3(0, 0.5, 0.5), new Vector3(-0.5, 0.5, 0));
