...
public class Pyraminx implements Puzzle {
  ...
  public Mesh getScrambledPuzzleMesh(ColorScheme colorScheme, String[] sequence) {
    ...
    Plane plane1 =
        new Plane(mesh.faces[0].vertices[0], mesh.faces[0].vertices[1], mesh.faces[0].vertices[2]);
    ...
    Plane plane2 =
        new Plane(mesh.faces[1].vertices[0], mesh.faces[1].vertices[1], mesh.faces[1].vertices[2]);
    ...
    Plane plane3 =
        new Plane(mesh.faces[2].vertices[0], mesh.faces[2].vertices[1], mesh.faces[2].vertices[2]);
    ...
    Plane plane4 =
        new Plane(mesh.faces[3].vertices[0], mesh.faces[3].vertices[1], mesh.faces[3].vertices[2]);
    ...
    return mesh.transform(Matrix44.rotationY(-Math.PI / 4))
